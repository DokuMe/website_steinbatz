					...
					<div class="content_wrap">
						<div class="top_panel_title">
							<div class="page_title">
								<h1 class="page_caption">Zimmer</h1>
							</div>
							<div class="breadcrumbs"><a class="breadcrumbs_item home" href="index.html">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Lagen</span></div>
						</div>
					</div>
				</div>
			</header>
									...
									<div class="sc_promo sc_promo_default sc_promo_size_normal sc_promo_no_paddings sc_promo_no_image">
										<div class="sc_promo_text" style="width: 100%;">
											<div class="sc_promo_text_inner sc_align_center">
												...
												<!--<div class="sc_promo_button_image sc_item_button_image"><img src="images/sinature.png" alt="" width="297" height="105"></div>-->
											</div>
										</div>
									</div>
							...
							<div class="wpb_wrapper">
								<div class="wpb_single_image wpb_content_element vc_align_left">
									<figure class="wpb_wrapper vc_figure">
										<a href="images/GAESTEHAUS_4.jpg" target="_self" class="vc_single_image-wrapper   vc_box_border_grey"><img width="1024" height="738" src="images/GAESTEHAUS_2.jpg" class="vc_single_image-img attachment-large" alt="image-17" /></a>
									</figure>
								</div>
							</div>
						</div>
					...
					<div class="wpb_column vc_column_container column-5_12">
						<div class="vc_column-inner ">
							<div class="wpb_wrapper">
								...
								<div class="wpb_single_image wpb_content_element vc_align_left">
									<figure class="wpb_wrapper vc_figure">
										<a href="images/GAESTEHAUS_9.jpg" target="_self" class="vc_single_image-wrapper   vc_box_border_grey"><img width="1024" height="683" src="images/GAESTEHAUS_5.jpg" class="vc_single_image-img attachment-large" alt="image-18" /></a>
									</figure>
								</div>
							</div>
						</div>
													...
													<div class="sc_testimonials_item">
														...
														<div class="sc_testimonials_item_author">
															<div class="sc_testimonials_item_author_data">
																<h4 class="sc_testimonials_item_author_title">Franz Steinbatz</h4>
										...
										<div class="sc_icons_columns sc_item_columns trx_addons_columns_wrap columns_padding_bottom">
											<div class="trx_addons_column-1_3">
												<div class="sc_icons_item sc_icons_item_linked">
													<div class="sc_icons_image"><img src="images/icon-01.png" alt="" width="276" height="276"></div>
