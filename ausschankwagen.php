											...
											<div class="sc_promo_text_inner">
												...
												<div class="sc_promo_content sc_item_content">
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p>Unser Ausschankwagen verfügt über:</p>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="wpb_wrapper">
									<div class="wpb_text_column wpb_content_element ">
										...
										<ul class="trx_addons_list trx_addons_list_circle trx_addons_list_dot_red">
												<li>überdachter Theke</li>
												<li>Kaltwasserleitung</li>
												<li>Abfluss</li>
												<li>Elektrik</li>
												<li>Kühlmöglichkeiten</li>
												<li>Beleuchtung</li>
												<li>Gläserspülmaschine</li>
												<li>Kassenladen</li>
												<li>ausreichend Platz, damit vier Personen effizient arbeiten können</li>
											</ul>
										</div>
									</div>
